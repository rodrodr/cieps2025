...
R es el lenguaje más empleado en las ciencias sociales hoy, pero esto puede cambiar en el futuro. Muchos modelos de IA se programan en Python y algunos investigadores empiezan a mezclar ambos lenguajes en sus análisis.
...
Especialización en [ciencia de datos](https://www.coursera.org/specializations/jhu-data-science#courses) de la Universidad Johns Hopkins en Coursera.

Una [introducción al R](https://www.coursera.org/learn/data-analysis-r?specialization=google-data-analytics) hecha por Google en Coursera.

Otra [Introducción al R](https://www.coursera.org/learn/introducton-r-programming-data-science#modules) de IBM, también en Coursera. 



### [**Practica con tus datos**]{style="color:darkred;"}

Lo más importante para aprender a programar es emplear tus propios datos o resolver problemas reales de análisis de datos con el lenguaje que deseas manipular. 
